...
describe('Login Router', () => {
  ...
  test('Should return accessToken when valid credentials are provided', async () => {
    const { sut, authUseCaseSpy } = makeSut()
    const httpRequest = {
      body: {
        email: 'valid_email@mail.com',
  ...
  test('Should return 500 if no authUseCaseSpy is provided', async () => {
  ...
  test('Should return 500 if authUseCaseSpy has no auth method', async () => {
